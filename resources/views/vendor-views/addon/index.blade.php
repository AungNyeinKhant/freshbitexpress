            ...
            <div class="card-body">
                <form action="{{route('vendor.addon.store')}}" method="post" class="row" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6 ">
                        ...
                        <input type="file" name="img" class="form-control" placeholder="Image Insert Here" required maxlength="191">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($addons as $key=>$addon)
                        <tr>
                            ...
                            <td>
                                <img src="{{asset('storage/app/public/Addon/')}}/{{$addon['img']}}" alt="" style="width: 200px;height:200px;" />
                            </td>
