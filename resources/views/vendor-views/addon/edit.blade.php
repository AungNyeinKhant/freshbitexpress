    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('vendor.addon.update',[$addon['id']])}}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    ...
                    @endif
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" min="0" max="999999999999.99" step="0.01" name="img"  class="form-control" placeholder="200" >
                        </div>
