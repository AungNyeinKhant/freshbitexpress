                    ...
                    <div class="card">
                        <div class="card-body p-xl-4">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                    ...
                                    <div class="form-group mb-0  lang_form default-form">
                                    <label for="contact" class="form-label">Please Select Restaurant Type<span class="text-danger">*</span></label>
                                        <select name="restaurantType" id="" class="form-control">
                                            <option value="" disabled>Please Select Restaurant Type</option>
                                            <option <?php if($shop['restaurant_type'] == "Small"){ echo "selected"; } ?> value="Small">Small</option>
                                            <option <?php if($shop['restaurant_type'] == "Medium"){ echo "selected"; } ?> value="Medium">Medium</option>
                                            <option <?php if($shop['restaurant_type'] == "Large"){ echo "selected"; } ?> value="Large">Large</option>
                                        </select>
                                    </div>
