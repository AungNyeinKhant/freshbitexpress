                            ...
                            <div class=" lang_form" >
                                ...
                                <div class="form-group" >
                                    ...
                                    <select class="form-control" name="restaurantType">
                                        <option <?php if($restaurant->restaurant_type == "Small"){ echo "selected"; } ?> value="Small">Small</option>
                                        <option <?php if($restaurant->restaurant_type == "Medium"){ echo "selected"; } ?> value="Medium">Medium</option>
                                        <option <?php if($restaurant->restaurant_type == "Large"){ echo "selected"; } ?> value="Large">Large</option>
                                    </select>
                                </div>
